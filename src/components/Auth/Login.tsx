...
const Login: React.FC = () => {
  ...
  const adminCredentials = [
    ...
    { role: 'Admin', name: 'Dr. Michael Smith', email: 'dr.smith@entnt.in', password: 'dental123' },
    { role: 'Admin', name: 'Dr. Emily Williams', email: 'dr.williams@entnt.in', password: 'dental123' },
  ];
  ...
  const patientCredentials = [
    ...
    { role: 'Patient', name: 'Sarah Wilson', email: 'sarah@entnt.in', password: 'patient123' },
